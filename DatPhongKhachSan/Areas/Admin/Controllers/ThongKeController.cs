    ...
    public class ThongKeController : Controller
    {
        ...
        private void Tab()
        {
            ...
            if (tong != null)
                ...
                ViewBag.tien_ht = "0";
            ViewBag.so_phieu_dat_phong = db.DonDatPhong.Where(u => u.MaTinhTrang == 1).Count();
            ViewBag.so_phong_dang_dat = db.Phong.Where(u => u.MaTinhTrang == 2).Count();
            ViewBag.so_dich_vu = db.DichVu.Count();
        }
        ...
        private void Char2(DateTime end)
        {
            ...
            for (int i = 1; i <= 7; i++)
            {
                ...
                DateTime f2 = f1.AddDays(1);
                var q = db.DonDatPhong.Where(t => t.NgayDen >= f1 && t.NgayDen < f2).Count();
                C2sl.Add(q);
